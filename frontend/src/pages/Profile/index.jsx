  ...
  return (<div className='flex mt-4 '>
    <aside  >
      <ul className='w-[146px] flex flex-col gap-2 pr-2 h-full'>
        ...
        <button onClick={logoutHandler} className='text-main block rounded-md text-white bg-red-500 text-center py-3 px-4 cursor-pointer'>Logout</button>
      </ul>
    </aside>
    <main className='w-full px-4 bg-back sm:px-6 shadow h-[70vh] overflow-hidden sm:rounded-lg' >
      <Outlet/>
    </main>
  </div>
  );
