...
import { useAddToCartMutation,useDeleteFromCartMutation } from '../store/cartApiSlice.js';
    ...
    <div className='bg-back p-2 h-full border border-slate-600 max-w-md min-h-[240px] max-h-[350px] rounded-md overflow-hidden' >
      <Link to={"/product/"+product._id}>
        <div className='relative h-[65%] '>
          <span className='absolute top-2 flex justify-center items-center cursor-pointer right-2 size-9 rounded-md p-2 shadow-md bg-white hover:scale-[1.15] hover:bg-red-600 '>
          ...
          {
            product.countInStock > 0 ? <span className='absolute w-9 h-9 p-2 flex justify-center items-center  rounded-md bottom-2 right-2 shadow-md cursor-pointer bg-white hover:scale-[1.15] hover:bg-blue-600 '>
