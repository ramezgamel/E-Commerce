function NotificationItem() {
  return (
    <div className="w-full h-auto relative">
                <div className="bg-white dark:bg-slate-900 dark:text-slate-100 mt-10 px-5 py-3.5 rounded-lg shadow hover:shadow-xl max-w-sm mx-auto transform hover:-translate-y-[0.125rem] transition duration-100 ease-linear">
                  <div className="w-full flex items-center justify-between">
            <span className="font-medium text-sm text-slate-400">New Notification</span>
            <button className="-mr-1 bg-slate-100 hover:bg-slate-200 text-slate-400 hover:text-slate-600 dark:bg-slate-800 dark:hover:bg-slate-700/70 dark:text-slate-400 dark:hover:text-slate-200 h-5 w-5 rounded-full flex justify-center items-center">
              ...
              <img className="h-16 w-16 rounded-full"  src="https://i.pravatar.cc/300" />
                <span className="absolute h-4 w-4 bg-green-400 rounded-full bottom-0 right-0 border-2 border-white dark:border-slate-900"></span>
                  </div>
