...
function Tabs({setCategory,category}) {
  ...
  return (
    <div className="fixed top-16 z-40 text-sm font-medium text-center text-gray-500 border-b pt-2 w-100 border-gray-200 dark:text-gray-400 dark:border-gray-700 bg-slate-50 dark:bg-gray-800">
