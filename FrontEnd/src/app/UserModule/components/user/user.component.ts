...
export class UserComponent {
  ...
  constructor(private fb:FormBuilder, private auth:UserService) { 
    ...
    this.registerForm = fb.group({
      ...
      email:['',[Validators.required, this.existsEmailValidator()]],
  ...
  get referral(){return this.registerForm.get('referral')}
  get phoneNumber(){return this.registerForm.get('phoneNumber') as FormArray}
  get address(){return this.registerForm.get('address') as FormArray  }
